...
public final class RespuestaXML {
  public static final void generar(
      HttpServletRequest request,
      HttpServletResponse response) {
    Log.println("RespuestaXML.generar()", "Atendiendo solicitud de impresión...");
      ...
      if (sentenciaDeSQL == null) {
        ...
        if (conjuntoDeResultados == null) {
          ...
          if (tablaPrueba.esConvertidaConExito()) {
            ...
            Despachador.deJSP(request, response, "/clases/RespuestaXML/generar.jsp");
          } else {
            response.setStatus(500);
            Despachador.deJSP(request, response, "/500.jsp");
          }
    ...
    Log.println("RespuestaXML.generar()", "Solicitud de impresión atendida.");
  }
}
