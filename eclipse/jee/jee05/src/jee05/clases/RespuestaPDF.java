...
public final class RespuestaPDF {
    public static final void generar(
      ...
      Log.println("RespuestaPDF.generar()", "Atendiendo solicitud de impresión...");
        ...
        if (sentenciaDeSQL == null) {
          ...
          if (conjuntoDeResultados == null) {
            ...
            if (tablaPrueba.esConvertidaConExito()) {
              ...
              Despachador.deServlet(request, response, "/servlets/clases/RespuestaPDF/generar");
            } else {
              response.setStatus(500);
              Despachador.deJSP(request, response, "/500.jsp");
            }
      ...
      Log.println("RespuestaPDF.generar()", "Solicitud de impresión atendida.");
    }
}
