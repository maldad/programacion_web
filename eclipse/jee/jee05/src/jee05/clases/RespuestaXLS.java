...
public final class RespuestaXLS {
  public static final void generar(
      HttpServletRequest request,
      HttpServletResponse response) {
    Log.println("RespuestaXLS.generar()", "Atendiendo solicitud de impresión ...");
      ...
      if (sentenciaDeSQL == null) {
        ...
        if (conjuntoDeResultados == null) {
          ...
          if (tablaPrueba.esConvertidaConExito()) {
            ...
            Despachador.deJSP(request, response, "/clases/RespuestaXLS/generar.jsp");
          } else {
            response.setStatus(500);
            Despachador.deJSP(request, response, "/500.jsp");
          }
    ...
    Log.println("RespuestaXLS.generar()", "Solicitud de impresión atendida.");
  }
}
