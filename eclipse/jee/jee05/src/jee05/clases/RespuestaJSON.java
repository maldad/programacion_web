...
public final class RespuestaJSON {
  public static final void generar(
    ...
    Log.println("RespuestaJSON.generar()", "Atendiendo solicitud de impresión...");
      ...
      if (sentenciaDeSQL == null) {
        ...
        if (conjuntoDeResultados == null) {
          ...
          if (tablaPrueba.esConvertidaConExito()) {
            ...
            Despachador.deJSP(request, response, "/clases/RespuestaJSON/generar.jsp");
          } else {
            response.setStatus(500);
            Despachador.deJSP(request, response, "/500.jsp");
          }
    ...
    Log.println("RespuestaJSON.generar()", "Solicitud de impresión atendida.");
  }
}
