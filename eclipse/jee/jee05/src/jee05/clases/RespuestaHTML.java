...
public final class RespuestaHTML {
  public static final void generar(
      HttpServletRequest request,
      HttpServletResponse response) {
    Log.println("RespuestaHTML.generar()", "Atendiendo solicitud de impresión...");
      ...
      if (sentenciaDeSQL == null) {
        ...
        if (conjuntoDeResultados == null) {
          ...
          if (tablaPrueba.esConvertidaConExito()) {
            ...
            Despachador.deJSP(request, response, "/clases/RespuestaHTML/generar.jsp");
          } else {
            response.setStatus(500);
            Despachador.deJSP(request, response, "/500.jsp");
          }
    ...
    Log.println("RespuestaHTML.generar()", "Solicitud de impresión en atendida.");
  }
}
